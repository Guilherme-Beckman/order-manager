...
@Document(collection = "storesAdress")
public class AddressModel {
	...
	public AddressModel(String id, String userId, String street, String number, String complement, String neighborhood, String city,
