...
import com.ms.user.rabbitMQ.producer.UserServiceRegisterReturnDataProducer;
...
public class UserServiceRegisterListener {
	...
	public void registerUser(@Payload Message userDTO) {
		...
		try {
			...
			var userBytes = this.userMessageConverter.convertUserToMessage(userdb,
					userDTO.getMessageProperties().getCorrelationId());
