...
import com.ms.user.rabbitMQ.producer.UserReturnDataProducerApiGateway;
...
public class UserDataListenerApiGateway {
	...
	@Autowired
	public UserReturnDataProducerApiGateway returnData;
	...
	@RabbitListener(queues = RabbitMQConfig.LOAD_USER_DETAILS_API_GATEWAY_QUEUE)
