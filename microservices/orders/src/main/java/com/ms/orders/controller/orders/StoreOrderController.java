...
public class StoreOrderController {
	...
	@GetMapping("/history")
	public ResponseEntity<List<OrderModel>> getStoreOrderHistory(HttpServletRequest httpServletRequest) {
		List<OrderModel> history = this.orderService.getStoreOrderHistory(httpServletRequest);
